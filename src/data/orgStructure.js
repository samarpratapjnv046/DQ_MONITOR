...
const generateSchemaMetrics = (schemaName, displayName, layer, tableNames) => {
  ...
  return {
    ...
    metrics: {
      ...
      tablesNeedingFixes: totalTables > 0 ? parseFloat((85 + (rng(0, 15))).toFixed(1)) : 0,
...
const aggregateMetrics = (children) => {
  ...
  return {
    ...
    tablesNeedingFixes: totTbl ? parseFloat((85 + ((cm.reduce((s, m) => s + m.tablesNeedingFixes, 0) / cm.length) - 85) * 1).toFixed(1)) : 0,
